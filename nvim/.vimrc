...
map <leader>s :!clear && rsync -zarv --progress --include="*/" --include="*.ipynb" --include="*.py" --include="*.json" --include="*.sh" --include="*.slurm" --exclude="*" /Users/vladsobal/Work/tdmpc2_public/.  devfair:~/work/tdmpc2_public/.;<CR>

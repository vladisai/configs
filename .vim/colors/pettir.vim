...
if &background == "light"
    ...
    hi Conditional gui=NONE guifg=#037764 guibg=NONE
    ...
    hi CursorLineNr gui=NONE guifg=#050505 guibg=NONE
    ...
    hi IncSearch gui=NONE guifg=NONE guibg=#fee495
    ...
    hi Special gui=NONE guifg=#f50000 guibg=NONE
    ...
    hi Statement gui=NONE guifg=#007e94 guibg=NONE
    ...
    hi String gui=NONE guifg=#db5800 guibg=NONE
    ...
    hi Type gui=NONE guifg=#ac1b1b guibg=NONE
